  ...
  .then(data => {
    ...
    if(data.modifiedCount){
        ...
        Swal.fire({
            ...
            imageUrl: 'https://png.pngtree.com/png-vector/20190301/ourmid/pngtree-vector-administration-icon-png-image_747092.jpg',
            imageWidth: 200,
            imageHeight: 200,
                ...
                <tr key={user._id}>
                  ...
                  <td>
                    {user.role === "admin" ? (
                      ...
                      <button className="btn bg-red-600 rounded-full" onClick={()=>handleAdmin(user)}>
                        <RiAdminLine className="text-white font-extrabold text-2xl" />
                      </button>
                    )}
                  </td>
                  ...
                  <th>
                    {
                      ...
                      <MdSportsMartialArts className="text-white font-extrabold text-2xl " />
                            ...
                            <button onClick={()=>handleInstructor(user)} className="btn bg-blue-500 rounded-full">
                      <MdSportsMartialArts className="text-white font-extrabold text-2xl " />
                    </button>
                        )
                    }
