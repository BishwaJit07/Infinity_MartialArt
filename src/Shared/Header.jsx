    ...
    <div>
      <div className="navbar bg-blue-900 bg-opacity-75 fixed z-10 max-w-screen-xl">
        <div className="navbar-start">
          ...
          <a className="font-bold text-xl text-pink-600">
            InfinityMarttialArts
          </a>
        </div>
          ...
          {user ? (
            <div className="flex justify-center items-center">
              ...
              <button
                ...
                className="p-2 rounded-2xl text-2xl text-white bg-pink-700 mx-4"
              >
                <FiLogOut />
              </button>
            </div>
            ...
            <Link
              to="/login"
              className="btn btn-outline text-white bg-pink-700"
            >
              Login
            </Link>
          )}
